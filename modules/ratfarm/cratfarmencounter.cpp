...
void CRatFarmEncounter::execute(const std::string_view& moduleName)
{
    ...
    Console::printLn(tr("And there she is, the crying lady. What crying lady? Well, the crying lady, every hero meets at "
                        "least once during his adventure."));
    Console::printLn(tr("\"My name is lady {0}, I live in the {0} house on the {0} farm. The "
                        "{0} farm is located in {0} vale. I am famous for farming the best...\"",
                        RatFarm::getCarrot()));
    Console::printLn(tr("\"{}s?\", you interrupt her impolitely", RatFarm::getCarrot()));
    Console::printLn(tr("\"No, {}s\", she corrects you.", RatFarm::getTurnip()));
    Console::printLn(tr("\"But rats eat all my harvest, please, dear hero, please help me!\""));
    Console::br();
    if (CMenu::executeAcceptRejectMenu() == CMenu::reject())
    {
        Console::printLn(tr("You dont like {}, you don't like rats, and this lady is strange "
                            "anyways. You decide to decline and go.",
                            RatFarm::getTurnip()));
        return;
    }

    Console::printLn(tr("This lady might be strang, but it is your job, no, your prefession, no your holy "
