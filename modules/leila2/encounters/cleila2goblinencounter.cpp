...
{
    Console::printLn(tr(
        "Backtracking {}s way since you first rescued her, you have seen a lot of the land, but not the "
        ...
        CC::fgLightMagenta(),
        CC::ccReset()));
    Console::printLn(tr("Finally, you found {}s {}, and before you can ask her to stay cautious, because that "
                                 "might be a trap, she runs towards her treasure, and... well... it was a trap.",
                                 Ressources::Game::princessLeila(),
                                 Ressources::Game::leilasRibbon()));
    Console::br();
    Console::printLn(tr(
        "{} gets hit by a club and is drawn into the woods. You run towards her, but all you can see is "
        "some {}, running away on a wild boar, with the lady of your over his shoulders.",
        Ressources::Game::princessLeila(),
        Leila2::greenskin()));
    Console::printLn(tr("At least you are able to recover her {}. You pick it up and put it in your pocket. "
                                 "Maybe this will make you her hero, when you give it back to her.",
                                 Ressources::Game::leilasRibbon()));
    Console::printLn(tr("You will have to find him and burn down his house, his family, his children and his whole "
