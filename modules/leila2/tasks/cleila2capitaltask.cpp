...
void CLeila2CapitalTask::execute()
{
    std::string townName;
    ...
    Console::printLn(tr(
        "Finally, you arrive at {}. You kept your promise and brought {} back home. This time you are let "
    ...
    Console::printLn(tr(
        "Taking a closer look at the king, you realize, that he is not the sublime type of wise, old man, "
    ...
    Console::printLn(tr(
        ...
        Ressources::Game::kingJesster()));
    Console::printLn(tr("This whole \"nameless hero\" - thing is going to far, you need a name! But before you can start "
    ...
    Console::printLn(tr(
        "\"As a sign of thankfulness, for saving my daughter, i hand you the {}, an old heirloom of the "
    ...
    Console::printLn(tr("This said, the guards lead you out of the capital, without even giving you a chance to say "
                     "goodby to the princess. What an underwhelming adventuere!"));
    Console::printLn(tr("You start thinking about abducting the princess yourself."));
    Console::br();
    Console::confirmToContinue();
