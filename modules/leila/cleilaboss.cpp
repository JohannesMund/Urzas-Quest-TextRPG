...
CLeilaBoss::CLeilaBoss() : CTwoEnemies(Ressources::Game::piefke(), Ressources::Game::schniefke())
{
    _name = "";
...
void CLeilaBoss::spoilsOfWar() const
{
...
void CLeilaBoss::passiveBattleAction(EWho who)
{
