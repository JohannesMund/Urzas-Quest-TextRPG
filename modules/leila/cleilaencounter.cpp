...
CLeilaEncounter::CLeilaEncounter()
{
...
unsigned int CLeilaEncounter::encounterChance(const EEncounterType&, const std::string_view&) const
{
    return 5;
}

std::string CLeilaEncounter::name() const
{
