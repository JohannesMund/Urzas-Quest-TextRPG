...
void CFishingVilleTownTask::execute()
{
    ...
    Console::printLn(tr(
        ...
        townName));
    Console::printLn(tr(
        "The last time, you tried to find those information, you ended up in the gutter, with no money, "
        "and a tattoo of {} on your arm. At least something, but definitely not what you where looking for.",
        Ressources::Game::princessLeila()));
    Console::printLn(
        tr("This time, you consciously avoid the dark and shady areas of {}, and ask around. still nobody "
