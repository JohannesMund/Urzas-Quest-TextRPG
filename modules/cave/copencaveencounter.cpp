...
void COpenCaveEncounter::execute(const std::string_view& moduleName)
{
    ...
    Console::printLn(tr("A tall, lanky guy, and a dog. Screaming. Running in your direction, followed by a cloud of dust, "
                        "stirred up by them. Their faces are marked with sheer panic."));
    Console::printLn(
        tr("\"Mo-mo-mo-mo-moooonsteeeer\" screems the guy. \"C-c-c-c-aaaaaaave\" screams the dog. Yes, this dog can talk. "
