...
void CDancingBard::execute(const std::string_view& moduleName)
{
    ...
    Console::printLn(
        tr("Entering {}, you see a huge uproar on the marketplace of the town. You go closer to see, what's "
           "going on and see, that the {} is in town.",
           townName,
           name()));
    Console::printLn(tr("This seems to be a welcomne Destraction from your hard adventurer chores, so you decide to watch "
                        "the show. This guy sure knows entertainment!"));
    Console::printLn(tr("The {} is singing and dancing an playing various instruments. The crowd sings along "
    ...
    Console::printLn(tr("In the end, you still don't know, who this {}Ur{}za{} - dude{} is, but you still "
