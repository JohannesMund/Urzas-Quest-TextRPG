...
void CInjuredPet::execute()
{
    ...
    {
        Console::br();
        Console::printLn(coreTr("With a smile, you remember how you found {} here",
    ...
    {
        Console::br();
        Console::printLn(coreTr("You see the corpse of the {} you left here dying. You feel pitty for the little guy.",
                                CGameManagement::getCompanionInstance()->name()));
        return;
    }

    Console::br();
    Console::printLn(coreTr("A suspicious noise is coming out of one of the bushes, you should have a look. Or maybe, "
    ...
    if (input == goAction)
    {
        Console::printLn(coreTr("Better safe than sorry! You decide to ignore the pittyful screams and leave."));
        Console::printLn(coreTr("The screams vanish shortly after."));
        _petIsDead = true;
        return;
    }
    ...
    Console::br();
    Console::printLn(
        coreTr("You follow the sounds, and find a tiny {} lying beneath a bush, desperately looking for help",
               CGameManagement::getCompanionInstance()->name()));
    Console::hr();
    ...
    {
        Console::printLn(coreTr("Better safe than sorry! You decide to ignore the pittyful little animal and leave."));
        Console::printLn(coreTr("The screams vanish shortly after."));
        _petIsDead = true;
        return;
    }
    ...
    Console::br();
    Console::printLn(coreTr("You decide to help the {}. a little water, a bandage for the broken limb and some "
                            "herbs and soon the little fellow is back on track.",
                            CGameManagement::getCompanionInstance()->name()));
    Console::printLn(
        coreTr("As soon as you leave, you realize, that {} follows you. Looks like, you have found a new friend.",
               CGameManagement::getCompanionInstance()->name()));
