...
void CFarm::execute()
{
    ...
    do
    {
        ...
        Console::cls();
        Console::printLn(coreTr("Every good town needs a farm. {} has a beautiful one! {} immediately rushes away "
        ...
        {
            Console::printLn(coreTr("The farmer takes a look at your friend. \"he looks great! for sure, he is one "
                                    "awesomne {}! But i am sure, with a little training, he could be even better.\"",
                                    CGameManagement::getCompanionInstance()->type()));
            Console::printLn(coreTr("You are intrigued, so you ask for prices."));
            Console::printLn(
                coreTr("The farmer takes another, closer look at {}, and replies \"I think, {} is a good price.\"",
                       CGameManagement::getCompanionInstance()->name(),
                       getTrainingCost()));

            if (getTrainingCost() <= CGameManagement::getPlayerInstance()->gold())
            {
                Console::printLn(coreTr("This sounds like a bargain!"));
            ...
            {
                Console::printLn(coreTr("This is too much! a little running around with you should do the same."));
