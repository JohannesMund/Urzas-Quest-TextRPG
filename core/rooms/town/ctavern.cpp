...
void CTavern::execute()
{
    ...
    do
    {
        Console::cls();
        Console::printLn(
            coreTr("Aaah, the tavern. Time for a rest, time for a cool ale! The tavern is crowded with hard "
        ...
        {
            Console::printLn(
                coreTr("You walk around in the tavern, talk to the people and listen to some conversations, "
...
void CTavern::bountyHunt()
{
    ...
    Console::printLn(coreTr("wanted for:"), Console::EAlignment::eCenter);
    ...
    Console::printLn(coreTr("Reward: {} Gold", reward));
    Console::printLn(
        coreTr("This guy shure looks dangerous, but the reward should be worth it. But the guy looks dangerous."));
    Console::hr();

    if (CMenu::executeAcceptRejectMenu() == CMenu::accept())
    {
        Console::printLn(
            coreTr("You feel brave and relentless, and decide to hunt this sucker down. You rip of his poster, "
