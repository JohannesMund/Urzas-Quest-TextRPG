...
void CStartingRoom::execute()
{
    ...
    {
        CRoom::execute();
        Console::printLn(coreTr("You can still see, where you woke up, when you started your adventure,"));
        return;
    }
    ...
    Console::br();
    Console::printLn(coreTr("You whake up, somewhere."));
    Console::printLn(coreTr("You have not the slightest idea, where you are."));
    Console::printLn(
        coreTr("You look around, and realize, that you are utterly defenseless. You need something to defend "
               "yourself. Hidden beneath one of the bushes, you see someting:"));
    Console::printLn(sword->description());
    Console::printLn(coreTr("This seems to be a decent weapon, at least for now."));
    Console::br();
    ...
    do
    {
        ...
        {
            Console::br();
            Console::printLn(coreTr("You take the {} and equip it. It looks good on you.", sword->name()));
        ...
        else
        {
            Console::br();
            Console::printLn(
                coreTr("Your parents always taught you, not to pick up stuff from the ground. Who knows wo owns "
                       "this sword. You leave the Sword where it is and turn around."));
            Console::printLn(
                coreTr("Than you start thinking. You are still defenseless. Maybe you should re-think your decision."));
            Console::br();
        }
    ...
    Console::br();
    Console::printLn(coreTr("Having the sword, you look further. You still do not feel like a big, sturdy warrior. "
                            "Something is missing."));
    Console::printLn(coreTr("Wait, is that...?"));
    ...
    do
    {
        ...
        {
            Console::br();
            Console::printLn(coreTr("You take the {} and equip it. Now you feel complete.", shield->name()));
        ...
        else
        {
            Console::br();
            Console::printLn(
                coreTr("Ok, by now, you should have realized, that you will not leave without the shield. Let's "
                       "shorten this, ok?"));
            Console::br();
        }
    } while (input != takeAction);
