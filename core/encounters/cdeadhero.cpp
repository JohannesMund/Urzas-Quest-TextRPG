...
void CDeadHero::execute(const std::string_view& moduleName)
{
    ...
    Console::printLn(coreTr(
        ...
        Ressources::Items::getRandomEquipmentNamesAndDescription(Ressources::Items::EType::eShield,
            ...
            .first.at(0)));
    Console::printLn(
        coreTr("He is dead. Definitely dead. He lies in a puddle of his own blood, the limbs broken, all his "
               "treasure gone (if he even had som treasure at all). All of his treasure?"));
    Console::printLn(coreTr("Maybe, just maybe you should have a look."));
    Console::br();
    ...
    Console::br();
    Console::printLn(
        coreTr("You approach the body, and one thing is for sure: This guy is dead. The opponent must have had "
    ...
    Console::br();
    Console::printLn(
        coreTr("Why waste a valuable item, when it can protect you? You take the T-shirt and equip it. You now "
